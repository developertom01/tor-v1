...
Local Supabase runs on ports 54341–54349.
...
- Tailwind CSS 4 with custom `@theme inline` — brand colors are `brand-50` through `brand-900` (brown and cream, e.g. brand-900: #3d2815, brand-500: #a67245, brand-50: #fdf9f5) and `gold-400/500/600`.
- Icons: `lucide-react`.
