...
export default function CtaSection() {
  ...
  return (
    <section ref={ref} className="relative py-24 md:py-36 overflow-hidden">
      ...
      {/* Brand overlay */}
      <div className="absolute inset-0 bg-brand-900/82" />
      <div className="absolute inset-0 bg-gradient-to-t from-brand-900/60 via-transparent to-brand-900/40" />
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <span className="text-brand-400 text-xs font-medium tracking-[0.25em] uppercase">Ready to wear</span>
            <span className="block w-8 h-px bg-brand-700" />
          </div>
          ...
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[0.95] tracking-tight">
            ...
            <span className="block gold-text">favourite fit</span>
          ...
          <p className="mt-8 text-brand-300 text-base md:text-lg max-w-xl mx-auto leading-relaxed">
            Join the community of fashion-forward people across Ghana who wear their story with Asse&apos;s Threads.
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link
              href="/products?category=spandex-2-piece"
