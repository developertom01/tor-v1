...
**Amal-shades** — e-commerce app for premium eyewear and custom prescription lenses. Next.js 16 App Router, Supabase (Postgres + Auth + Storage), Paystack payments. Currency is GHS (Ghana Cedis).

### Local Supabase ports

This store runs on ports 54351–54359 so it can run alongside other stores simultaneously.
...
- Tailwind CSS 4 with custom `@theme inline` — brand colors are `brand-50` through `brand-900` and `gold-400/500/600`.
- Icons: `lucide-react`.
