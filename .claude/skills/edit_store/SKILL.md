...
- **Landing page rewrites are creative.** If the user asks for a new landing page or major copy changes, apply the same creative direction as onboarding — compelling, conversion-focused, brand-voiced. But if they just want a word changed, change the word.
